            ...
            child: Material(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  ...
                  final success = await authProvider.selectChild(child);
                  ...
                  // บันทึกลง SecureStorage (อ่านตอน restore) + SharedPreferences (fallback)
                  // อ่าน parentUid ก่อน await เพื่อไม่ใช้ BuildContext ข้ามกัน
                  ...
                  if (parentUid != null) {
                    await SecureStorageService.saveParentUid(parentUid);
                  }
