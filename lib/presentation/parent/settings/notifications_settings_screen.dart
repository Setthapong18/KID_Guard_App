...
// ผู้ใช้สามารถเปิด/ปิด:
// - แจ้งเตือนแอพถูกบล็อก, เวลาใกล้หมด, ตำแหน่ง, รายงานประจำวัน
// - เสียงแจ้งเตือน, การสั่น
//
// บันทึกค่าทั้ง SharedPreferences (local) และ Firestore (sync ข้ามอุปกรณ์)
// โหลดค่าจาก Firestore ก่อน → ถ้าไม่มีจะใช้ค่า local
