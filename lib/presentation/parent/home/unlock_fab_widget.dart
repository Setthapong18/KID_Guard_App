...
class UnlockFabWidget extends StatelessWidget {
  ...
  const UnlockFabWidget({
    required this.parentUid, required this.lockedChild, required this.colorScheme, required this.pulseAnimation, super.key,
  });
  ...
  Future<void> _unlockChildDevice(BuildContext context) async {
    try {
