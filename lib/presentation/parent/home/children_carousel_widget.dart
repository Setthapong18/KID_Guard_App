...
class ChildrenCarouselWidget extends StatelessWidget {
  ...
  const ChildrenCarouselWidget({
    required this.children, required this.colorScheme, required this.selectedChildIndex, required this.onChildSelected, required this.parentUid, required this.todayStr, super.key,
  });
