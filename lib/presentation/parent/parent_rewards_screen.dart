...
// Sub-widgets — แยกออกมาเพื่อลดขนาดไฟล์และเพิ่ม Maintainability
import 'rewards/reward_card_widget.dart';
import 'rewards/activity_list_widget.dart';
...
class ParentRewardsScreen extends StatefulWidget {
  ...
  const ParentRewardsScreen({required this.child, super.key});
...
class _ParentRewardsScreenState extends State<ParentRewardsScreen> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TableCalendar(
                          ...
                          onDaySelected: rewardsProvider.selectDay,
          ...
          // ✅ Shimmer Loading Overlay — ดูเป็น Professional แทน CircularProgressIndicator
          if (rewardsProvider.isLoading)
            ShimmerWidgets.dashboardLoading(context),
        ],
      ),
    );
  }

  // _buildRewardCard ย้ายไปเป็น RewardCard widget แล้ว เหลือ wrapper method ไว้เพื่ออ้างอิงในไฟล์นี้
  Widget _buildRewardCard(
    ...
    return RewardCard(
      ...
      onLongPress: _showRewardOptions,
    );
  }

  // _buildActivityList ย้ายไปเป็น ActivityListWidget แล้ว
