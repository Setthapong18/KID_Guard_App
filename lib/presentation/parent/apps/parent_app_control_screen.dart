          ...
          appBar: AppBar(
            ...
            title: Text(
              widget.childName != null
                  ? AppLocalizations.of(context)!.appControlWithChild(widget.childName!)
                  : AppLocalizations.of(context)!.appControl,
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: isSystemActive ? AppLocalizations.of(context)!.searchApps : 'ระบบไม่ทำงาน',
          ...
          children: [
            Container(
              ...
              child: Row(
                ...
                children: [
                  _buildStatItem(
                    AppLocalizations.of(context)!.totalApps,
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              isBlocked ? AppLocalizations.of(context)!.blocked : AppLocalizations.of(context)!.allowed,
                              style: TextStyle(
                                fontSize: r.sp(12),
                                fontWeight: FontWeight.bold,
                                color: isBlocked ? Colors.red : Colors.green,
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            _buildDetailRow('Status', app.isLocked ? AppLocalizations.of(context)!.blocked : AppLocalizations.of(context)!.allowed),
            const SizedBox(height: 12),
            _buildDetailRow(
              'Type',
