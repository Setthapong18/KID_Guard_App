// ==================== Online Status Card ====================
// การ์ดแสดงสถานะออนไลน์ของเด็กในหน้า Activity
//
// แสดง:
// - ไฟเขียว pulse (ถ้าออนไลน์) หรือไฟเทา (ถ้าออฟไลน์)
// - ระยะเวลาที่ออนไลน์ / เวลาที่ active ล่าสุด
// - Badge "LIVE" (ถ้าออนไลน์)
// - ปุ่ม Unlock (ถ้าเครื่องถูกล็อก)
//
// เช็คสถานะออนไลน์: ถ้า lastActive < 2 นาที = ถือว่าออนไลน์
...
class OnlineStatusCard extends StatelessWidget {
  ...
  const OnlineStatusCard({
    required this.child, required this.pulseAnimation, required this.onUnlockTap, super.key,
  });
          ...
          decoration: BoxDecoration(
            color: isOnline
                ? _accentGreen.withValues(
                    alpha: 0.08 + pulseAnimation.value * 0.05,
                  )
