// ==================== Activity Child Selector ====================
// ตัวเลือกเด็กแบบเลื่อนแนวนอน (pill buttons)
// ใช้ในหน้า Activity เพื่อสลับดูข้อมูลสถิติของเด็กแต่ละคน
// แสดงจุดเขียวเล็กๆ ถ้าเด็กออนไลน์อยู่ (lastActive < 2 นาที)
...
class ActivityChildSelector extends StatelessWidget {
  ...
  const ActivityChildSelector({
    required this.children, required this.selectedChildId, required this.onChildSelected, super.key,
  });
